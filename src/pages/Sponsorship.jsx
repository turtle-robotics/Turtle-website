      ...
      <section className="py-16 px-4 bg-surface">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extralight text-text mb-8">
                  ...
                  <ul className="space-y-3">
                    {tier.benefits.map((benefit, benefitIndex) => (
                      <li key={benefitIndex} className="flex items-start">
                        <span className="text-accent/80 mr-3 mt-1">✓</span>
      ...
      {showEmailPopup && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md" onClick={() => setShowEmailPopup(false)}>
          ...
          >
            ...
            <h3 className="text-3xl font-extralight text-text mb-3 text-center">
              Get In Touch
            </h3>
            ...
            <div className="bg-surface rounded-xl p-6 mb-6 border-2 border-border">
              ...
              <p className="text-xl font-medium text-accent text-center break-all">
