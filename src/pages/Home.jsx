  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        >
          <div className="absolute inset-0 from-gray-900 via-gray-800 to-gray-900"></div>
        ...
        <section className="py-24 px-4">
          ...
          <div className="glass-card p-10 rounded-2xl text-center transition-all duration-300 mt-8 max-w-3xl mx-auto">
            ...
            <ul className="text-gray-400 font-light leading-relaxed space-y-3 flex flex-col items-center justify-center max-w-xl mx-auto pl-0">
        ...
        {/* Contact Section */}
        <section className="py-24 px-4 from-gray-800 to-gray-900">
