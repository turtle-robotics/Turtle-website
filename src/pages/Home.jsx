      ...
      <div className="min-h-screen">
        ...
        <section className="py-24 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="glass-card p-10 rounded-2xl text-center transition-all duration-300">
                ...
                <h3 className="text-xl font-light mb-4 text-gray-800 dark:text-gray-200">
                  Student Leadership
                </h3>
          ...
          <div className="glass-card p-10 rounded-2xl text-center transition-all duration-300 mt-8 max-w-3xl mx-auto">
            <div className="text-5xl mb-6">🏆</div>
            <h3 className="text-2xl font-light mb-4 text-gray-800 dark:text-gray-200">
              Event Accolades
            </h3>
            <ul className="text-gray-600 dark:text-gray-400 font-light leading-relaxed space-y-3 flex flex-col items-center justify-center max-w-xl mx-auto pl-0">
              <li className="flex items-center justify-center">
                ...
                <span className="text-center">
                  1st Place at TAMU Project Showcase '21
                </span>
              </li>
              <li className="flex items-center justify-center">
                <span className="text-yellow-600 dark:text-yellow-400 mr-3 text-lg">
                ...
                <span className="text-center">
                  3rd Place at TAMU Innovation Expo '25
                </span>
              </li>
              <li className="flex items-center justify-center">
                <span className="text-yellow-600 dark:text-yellow-400 mr-3 text-lg">
                ...
                <span className="text-center">
                  Awardee at Texas Robot Combat Texas Cup '25
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="md:hidden fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="relative bg-gradient-to-br from-yellow-50 to-amber-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-2xl shadow-2xl border-2 border-yellow-400 dark:border-yellow-600 max-w-sm w-full">
              ...
              >
                ...
                <div className="text-sm font-bold text-yellow-600 dark:text-yellow-400 mb-3 uppercase tracking-wide">
                  📌 Profit Share!
                </div>
                <div className="text-3xl text-gray-800 dark:text-gray-200 mb-4 leading-tight">
                  Kung Fu Tea
                </div>
                <div className="text-xl font-light text-gray-600 dark:text-gray-400 mb-2">
                  February 19, 2026
                </div>
                <div className="text-xl font-light text-gray-600 dark:text-gray-400 mb-2">
                  723 S Texas Ave, College Station, TX 77840
                </div>
                <div className="text-base font-light text-gray-600 dark:text-gray-400 mb-6">
        ...
        {ENABLE_SHOWCASE_POPUPS && (
          ...
          >
            <div className="relative bg-gradient-to-br from-yellow-50 to-amber-50 dark:from-gray-800 dark:to-gray-700 p-6 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 rotate-2 hover:rotate-0 w-64 border-2 border-yellow-400 dark:border-yellow-600">
              ...
              <div className="text-xs font-bold text-yellow-600 dark:text-yellow-400 mb-2 uppercase tracking-wide">
                📌 Profit Share!
              </div>
              <div className="text-2xl text-gray-800 dark:text-gray-200 mb-2">
                Kung Fu Tea
              </div>
              <div className="text-base font-light text-gray-600 dark:text-gray-400 mb-1">
                February 19, 2026
              </div>
              <div className="text-base font-light text-gray-600 dark:text-gray-400 mb-3">
                723 S Texas Ave, College Station, TX 77840
              </div>
              <div className="text-xs text-yellow-600 dark:text-yellow-400 underline group-hover:text-yellow-700 dark:group-hover:text-yellow-300 font-medium">
                Put your receipt in the bucket at checkout!
              </div>
              <div className="text-xs text-yellow-600 dark:text-yellow-400 underline group-hover:text-yellow-700 dark:group-hover:text-yellow-300 font-medium mt-2">
                Get Directions →
              </div>
            </div>
          </a>
        ...
        <section className="py-24 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex justify-center">
              <div className="rounded-2xl border-4 border-gray-300 dark:border-gray-700 shadow-xl bg-white/60 dark:bg-gray-900/60 p-4 w-full max-w-[1300px]">
                <div
