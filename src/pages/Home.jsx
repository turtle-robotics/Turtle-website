  ...
  <div className="relative text-center max-w-6xl mx-auto z-10">
    <div className="glass-card p-16 rounded-3xl">
      ...
      <div className="flex flex-col sm:flex-row gap-6 justify-center items-center relative z-50">
        <Link 
          to="/projects" 
          className="hero-button inline-flex bg-gradient-turtle text-gradient-foreground px-10 py-5 rounded-xl font-normal tracking-wide hover:!scale-105 transition-all duration-300 will-change-transform"
        >
          EXPLORE PROJECTS
        </Link>
        <Link 
          to="/about" 
          className="hero-button inline-flex glass-card text-accent px-10 py-5 rounded-xl font-normal tracking-wide hover:!scale-105 transition-all duration-300 will-change-transform bg-surface"
        >
          LEARN MORE
        </Link>
      </div>
...
<div className="absolute bottom-0 left-0 right-0 z-10">
  <ProjectTicker projects={projects} />
        ...
        <div className="md:hidden fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="relative bg-gradient-to-br from-surface to-background p-8 rounded-2xl shadow-2xl border-2 border-accent max-w-sm w-full">
            ...
            >
              ...
              <div className="text-sm font-bold text-accent mb-3 uppercase tracking-wide">📌 Don't Miss This Event!</div>
              <div className="text-4xl font-extralight text-text mb-4 leading-tight">TURTLE Showcase</div>
              <div className="text-xl font-light text-muted mb-2">November 21, 2025</div>
              <div className="text-xl font-light text-muted mb-2">1:00 PM - 5:00 PM</div>
              <div className="text-base font-light text-muted mb-6">Zachry Engineering Building<br/>Virginia C Brown Atrium</div>
      ...
      {ENABLE_SHOWCASE_POPUPS && (
        ...
        >
          <div className="relative bg-gradient-to-br from-surface to-background p-6 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 rotate-2 hover:rotate-0 w-64 border-2 border-accent">
            <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 w-7 h-7 bg-accent rounded-full shadow-md"></div>
            <div className="text-xs font-bold text-accent mb-2 uppercase tracking-wide">📌 Don't Miss!</div>
            <div className="text-2xl font-extralight text-text mb-2">TURTLE Showcase</div>
            <div className="text-base font-light text-muted mb-1">November 21, 2025</div>
            <div className="text-base font-light text-muted mb-3">1:00-5:00 PM</div>
            <div className="text-xs text-accent underline group-hover:brightness-110 font-medium">Click for more info →</div>
          </div>
        </a>
      )}
