        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-600 dark:text-gray-400">Total Sponsors</span>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-600 dark:text-gray-400">Showcase Registrations</span>
              <svg className="w-5 h-5 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-600 dark:text-gray-400">Today's Sponsors</span>
              <svg className="w-5 h-5 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-600 dark:text-gray-400">Today's Showcase</span>
              <svg className="w-5 h-5 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
          ...
          <div className="p-6 border-b border-gray-200 dark:border-gray-700">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() => exportToCSV(currentData, activeTab === 'sponsors' ? 'sponsors' : 'showcase')}
          ...
          <div className="p-6">
            {loading ? (
              <div className="text-center py-12 text-gray-600 dark:text-gray-400">
                <svg className="animate-spin h-10 w-10 mx-auto mb-4" fill="none" viewBox="0 0 24 24">
                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
                Loading data...
              ...
              <div className="text-center py-12 text-gray-600 dark:text-gray-400">
                No {activeTab === 'sponsors' ? 'contacts' : 'registrations'} found.
              </div>
            ) : (
                ...
                {activeTab === 'sponsors' ? (
                    ...
                    >
                      ...
                      <div className="grid md:grid-cols-2 gap-4 mb-4">
                        <div>
                          ...
                          <p className="text-gray-800 dark:text-gray-200">{contact.email}</p>
                        </div>
                        {contact.company && (
                          <div>
                            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Company:</span>
                            <p className="text-gray-800 dark:text-gray-200">{contact.company}</p>
                          </div>
                        )}
                        {contact.phone && (
                          <div>
                            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Phone:</span>
                            <p className="text-gray-800 dark:text-gray-200">{contact.phone}</p>
                          </div>
                        )}
                      </div>
                  ...
                  filteredShowcase.map((reg) => (
                    ...
                    >
                      ...
                      <div>
                        <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Favorite Projects:</span>
                        <p className="text-gray-800 dark:text-gray-200 mt-2 p-4 bg-white dark:bg-gray-800 rounded-lg">
