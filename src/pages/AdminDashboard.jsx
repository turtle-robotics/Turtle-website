 ...
 *
 * Administrative interface for managing form submissions and events.
 * Features:
 * - Email/password authentication with Supabase
 * - View and manage sponsor contact submissions
 * - View and manage showcase event registrations
 * - Search and filter submissions
 * - Tab-based interface for different data types
 * - User session management (login/logout)
 *
 * Requires authentication to access. Fetches data from Supabase tables:
 * - sponsor_contacts
 * - showcase_project_interest
 */
...
const AdminDashboard = () => {
  ...
  const [activeTab, setActiveTab] = useState("sponsors"); // 'sponsors' | 'showcase'
          ...
          <div className="p-6 border-b border-gray-200 dark:border-gray-700">
            <div className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 transition-colors outline-none"
              />
              ...
              <div className="space-y-4">
                {activeTab === "sponsors"
                  ? filteredSponsors.map((contact) => (
                      <div
                        key={contact.id}
                        className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 p-6 rounded-xl"
                      >
