      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center px-4">
        ...
        <div className="relative text-center max-w-6xl mx-auto z-10">
          ...
          <div className="launching-text mb-8">
            <div className="inline-block bg-gradient-to-r from-yellow-500 to-amber-500 text-white px-8 py-4 rounded-2xl text-2xl md:text-3xl font-light">
              Launching Fall 2025
            </div>
          </div>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a 
            ...
            className="inline-block bg-gradient-to-r from-yellow-500 to-amber-500 text-white px-12 py-5 rounded-xl text-lg font-light tracking-wide hover:scale-105 transition-all duration-300 shadow-lg"
          >
            GET UPDATES
          </a>
        </div>
