      ...
      <section className="py-24 px-4 bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            ...
            className="inline-block bg-gradient-turtle text-gradient-foreground px-12 py-5 rounded-xl text-lg font-light tracking-wide hover:scale-105 transition-transform duration-300 shadow-lg"
          >
            GET UPDATES
          </a>
        </div>
