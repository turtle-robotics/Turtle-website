 ...
 * Carousel Component
 *
 * Interactive drag-to-scroll carousel displaying Hatchling program timeline.
 * Features:
 * - Framer Motion drag interactions
 * - Auto-play with pause on hover
 * - Week-by-week program breakdown with icons
 * - Expandable detail cards
 *
 * @param {Object} props
 * @param {Array} props.items - Optional custom items (defaults to PROGRAM_ITEMS)
 */
...
// Hatchling program timeline data
const PROGRAM_ITEMS = [
  {
    title: "Week 1-3",
    description:
          ...
          return (
            ...
            >
              ...
              <div className="carousel-item-content">
                ...
                <p className="carousel-item-details">{item.details}</p>
              </div>
            </motion.div>
          );
        })}
