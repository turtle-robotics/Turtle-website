 ...
 *
 * Reusable image carousel with prev/next controls and auto-play.
 * Features:
 ...
 * @param {number} props.intervalMs - Auto-play interval in milliseconds (default: 4000)
 * @param {string} props.className - Custom CSS classes for container
 */
import { useEffect, useMemo, useRef, useState } from "react";

/**
 * ArrowButton Component
 * Reusable navigation button for carousel
        ...
        {slides.map((_, i) => (
          <button
            ...
            className={`w-2.5 h-2.5 rounded-full transition-all ${
              i === index
                ? "bg-accent shadow ring-2 ring-accent/50 w-4"
