/**
 * ShowcaseProjectInterestForm Component
 *
 * Form for visitors to express interest in attending the project showcase.
 * Collects name, email, and favorite projects, stores in Supabase database.
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus({
        type: "success",
        message:
          "Thank you! Your interest has been recorded. We look forward to seeing you at the showcase!",
      });
    ...
    <section className="py-16 px-4 bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-extralight text-text mb-4">
            Showcase <span className="text-accent">Project Interest Form</span>
          </h2>
