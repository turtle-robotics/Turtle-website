 ...
 *
 * Centralized data source for all TURTLE Robotics projects.
 * Contains:
 * - Complete project information (title, description, team lead, goals)
 * - Project metadata (category, tags, status, duration)
 * - Images and resources
 * - Skills and technologies required/used
 *
 * Projects are alphabetically ordered by title for easy lookup.
 * Each project has a unique 'id' used for routing and filtering.
 */
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "A Stewart-platform-based prosthetic ankle to restore full range of motion to below-the-knee amputees.",
    category: "Biomedical Robotics",
    tags: [
      "Prosthetics",
      "Controls",
  ...
  },
  {
    ...
    description:
      "Designing assistive robotic garments, starting with a wearable corset for posture, sensing, and biomechanical feedback.",
  ...
  },
  {
    ...
    description:
      "Autonomous wearable monitoring canine vitals with alerts, GPS, and smartphone connectivity.",
    category: "Wearable Robotics",
    tags: [
      "Wearables",
      "Biosensors",
